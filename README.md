...
python3 -m py_compile ./routers/phones_contacts.py && echo OK || echo FAIL
...
python3 -m py_compile ./routers/template_manager.py && echo OK || echo FAIL
# LOGGING
